...
export default function FeedbackPage() {
    ...
    useEffect(() => {
        if (!orgId || !isAdmin || isSuperAdmin) return;
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                    {feedbacks.map((feedback) => (
                        <div
                            ...
                            style={{
                                padding: "1.5rem",
                                borderLeft: feedback.isGuest
                                    ? (feedback.status === "pending" ? "4px solid #ff9800" : "4px solid #4caf50")
                                    : (feedback.status === "pending" ? "4px solid var(--accent)" : "4px solid var(--primary)")
                            }}
                        >
                                ...
                                <div>
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.5rem", flexWrap: "wrap" }}>
                                        ...
                                        <span style={{
                                            ...
                                            borderRadius: "4px",
                                            background: feedback.isGuest ? "rgba(255, 152, 0, 0.15)" : `${getCategoryColor(feedback.category)}15`,
                                            color: feedback.isGuest ? "#ff9800" : getCategoryColor(feedback.category),
                                            fontWeight: "600"
                                        }}>
                                            {feedback.isGuest ? "비회원 문의" : getCategoryLabel(feedback.category)}
                                        </span>
